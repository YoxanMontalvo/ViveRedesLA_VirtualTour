...
function createInfoHotspot(position, text, title, image, description) {
    let infospot = new PANOLENS.Infospot(350, PANOLENS.DataImage.Information);
...
function createSceneHotspot(position, sceneURL, text, title) {
    const sceneHotspot = new PANOLENS.Infospot(300, PANOLENS.DataImage.Door);
    ...
    sceneHotspot.addEventListener('click', () => {
        console.log('Hotspot clickeado, cambiando a:', sceneURL);
...
function createPageHotspot(position, pageURL, text, title) {
    const pageHotspot = new PANOLENS.Infospot(300, PANOLENS.DataImage.Door);
