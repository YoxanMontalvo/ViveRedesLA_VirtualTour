...
const resetGame = () => {
    correctLetters = [];
    wrongGuessCount = 0;
    hangmanImage.src = `${base_url}/resources/img/games/hangman/hangman-0.svg`;
...
const gameOver = (isVictory, timeUp = false) => {
    ...
    gameModal.querySelector("img").src = `${base_url}/resources/img/games/hangman/${isVictory ? 'victory' : 'lost'}.gif`;
...
const initGame = (button, clickedLetter) => {
    if (currentWord.includes(clickedLetter)) {
        ...
        wrongGuessCount++;
        hangmanImage.src = `${base_url}/resources/img/games/hangman/hangman-${wrongGuessCount}.svg`;
    }
