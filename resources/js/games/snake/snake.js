...
var sounds = {};
sounds.eat = new Howl({src: [`${base_url}resources/sounds/games/snake/comiendo.mp3`]});
sounds.fail = new Howl({src: [`${base_url}resources/sounds/games/snake/muriendo.mp3`], volume: 0.25});
sounds.fail.rate(4);
